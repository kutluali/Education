...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entity.Entities.CourseCategory", b =>
                {
                    b.Property<int>("CourseCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entity.Entities.CourseRegister", b =>
                {
            ...
            modelBuilder.Entity("Entity.Entities.CourseVideo", b =>
                {
            ...
            modelBuilder.Entity("Entity.Entities.Subscriber", b =>
                {
            ...
            modelBuilder.Entity("Entity.Entities.TeacherSocial", b =>
                {
            ...
            modelBuilder.Entity("Entity.Entities.Testimonial", b =>
                {
            ...
            modelBuilder.Entity("Entity.Entities.Blog", b =>
                {
                    b.HasOne("Entity.Entities.BlogCategory", "BlogCategory")
                        .WithMany("Blogs")
                        .HasForeignKey("BlogCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Entity.Entities.AppUser", "Writer")
                        .WithMany("Blogs")
            ...
            modelBuilder.Entity("Entity.Entities.Course", b =>
                {
                    ...
                    b.HasOne("Entity.Entities.CourseCategory", "CourseCategory")
                        .WithMany("Courses")
            ...
            modelBuilder.Entity("Entity.Entities.TeacherSocial", b =>
                {
                    b.HasOne("Entity.Entities.AppUser", "Teacher")
